...
describe("template gallery browser render", () => {
  it("renders every gallery source to at least twenty-five PNG pages, a PDF, and a PPTX", async () => {
    ...
    for (const entry of index) {
      ...
      expect(result.inspection.slides.length).toBeGreaterThanOrEqual(25);
      expect(
