(() => {
  ...
  vietnameseFontStyle.textContent =
    ...
    '@media (min-width:521px) and (max-width:879px){#home-hero-title{position:absolute!important;top:var(--base-padding-y)!important;left:6rem!important;right:9rem!important;width:auto!important;max-width:100%!important;margin:0!important;padding:.35em .55em!important;border-radius:8px!important;background:#f0f1fa!important;color:#101116!important;font-size:clamp(11px,1.8vw,13px)!important;line-height:1.08!important;z-index:54!important}}' +
    '@media (min-width:521px) and (max-width:879px){#home-hero{grid-template-rows:calc(var(--header-size)*3 + 1rem) minmax(0,1fr)!important}#home-hero-visual-container{grid-row:2!important}}' +
    '@media (min-width:813px) and (max-width:879px){#home-hero-title{top:calc(var(--base-padding-y) + 8px)!important}}' +
    '@media (min-width:521px) and (max-width:879px){#home-hero-title .line{overflow:visible!important}#home-hero-title .word{transform:none!important}}';
  ...
  if (new URLSearchParams(window.location.search).has("water-page-embed")) {
    ...
    embeddedLoaderStyle.textContent =
      ...
      "@media (min-width:521px) and (max-width:879px){#home-hero-title{left:10rem!important;right:13rem!important}}";
