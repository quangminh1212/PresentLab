...
const COPY = {
  ...
  en: {
    ...
    heroTitleA: "We turn ideas into",
    heroTitleB: "memorable visual stories.",
    heroLede: "Presentation design shaped by image, rhythm and point of view.",
  ...
  zh: {
    ...
    menuClose: "关闭菜单",
    heroTitleA: "将想法转化为",
    heroTitleB: "令人难忘的视觉故事。",
    heroLede: "以视觉、节奏与独特视角，设计令人印象深刻的演示。",
    heroExplore: "浏览模板库",
    heroBrief: "开始提交简报",
