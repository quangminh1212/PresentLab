...
const COPY = {
  vi: {
    ...
    menuOpen: "Mở menu",
    menuClose: "Đóng menu",
    heroEyebrow: "STUDIO KỂ CHUYỆN BẰNG HÌNH ẢNH",
    heroTitleA: "Đừng chỉ trình bày.",
    heroTitleB: "Hãy khiến họ nhớ.",
    heroLede: "XLab kết hợp nội dung, hình ảnh và nhịp chuyển động để câu chuyện của bạn được nhớ lâu.",
    ...
    heroScrollCue: "Cuộn để khám phá",
  ...
  en: {
    ...
    heroEyebrow: "VISUAL STORY STUDIO",
    heroTitleA: "Don't just present.",
    heroTitleB: "Make it unforgettable.",
    heroLede: "XLab blends story, design and motion into presentations people remember.",
    heroExplore: "Explore the library",
    heroBrief: "Start a brief",
    ...
    heroScrollCue: "Scroll to discover",
  ...
  zh: {
    ...
    heroEyebrow: "视觉叙事工作室",
    heroTitleA: "不止展示想法。",
    heroTitleB: "让每一页都令人难忘。",
    heroLede: "融合内容、视觉与动效，让你的演示更引人入胜。",
    heroExplore: "浏览模板库",
    heroBrief: "开始提交简报",
