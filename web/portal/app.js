...
const COPY = {
  vi: {
    ...
    menuOpen: "Mở menu",
    menuClose: "Đóng menu",
    heroEyebrow: "INTERACTIVE PRESENTATION WORLD",
    heroTitleA: "Lái ý tưởng đi xa.",
    heroTitleB: "Khám phá thế giới XLab.",
    heroLede:
      "Điều khiển một không gian 3D, ghé qua các hệ thống hình ảnh và gửi brief khi bạn đã tìm thấy đúng hướng cho câu chuyện của mình.",
    heroExplore: "Bắt đầu lái",
    heroBrief: "Mở brief lab",
    heroStatTemplates: "hệ thống để khám phá",
    heroStatFormat: "drive / discover",
  ...
  en: {
    ...
    heroEyebrow: "INTERACTIVE PRESENTATION WORLD",
    heroTitleA: "Drive the idea forward.",
    heroTitleB: "Explore the XLab world.",
    heroLede:
      "Drive through a living 3D space, discover visual systems, and send a brief when the right direction clicks.",
    heroExplore: "Start driving",
    heroBrief: "Open brief lab",
    heroStatTemplates: "systems to explore",
    heroStatFormat: "drive / discover",
  ...
  zh: {
    ...
    menuOpen: "打开菜单",
    menuClose: "关闭菜单",
    heroEyebrow: "互动演示文稿世界",
    heroTitleA: "让想法向前行驶。",
    heroTitleB: "探索 XLab 世界。",
    heroLede: "在一个会呼吸的 3D 空间里探索视觉系统，找到方向后直接提交简报。",
    heroExplore: "开始驾驶",
    heroBrief: "打开简报实验室",
    heroStatTemplates: "套系统可探索",
    heroStatFormat: "驾驶 / 探索",
